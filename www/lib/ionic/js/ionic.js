...
'use strict';
  ...
  // When an item is dragged, we need to reorder any players for sorting purposes
  ...
  /**
   * The ListView handles a list of players. It will process drag animations, edit mode,
  ...
  ionic.views.ListView = ionic.views.View.inherit({
    ...
    didScroll: function(e) {
      if(this.isVirtual) {
        ...
        // Compute how many players per viewport size can show
        ...
        // Get the players we need to remove
    ...
    didStopScrolling: function(e) {
      if(this.isVirtual) {
        ...
        // Once scrolling stops, check if we need to remove old players
